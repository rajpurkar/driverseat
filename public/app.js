...
function($scope, $window, editor, util, key, video, videoProjection, radar) {
	...
	var camera, renderer,
		...
		datafiles = {
            points: "gilroy/map.json.zip",
			gps: "gilroy/gps.json.zip",
			lanes: "gilroy/lanes_done.json.zip",
			planes: "gilroy/planes.json.zip",
			video: "gilroy/cam_2.zip",
            radar: "gilroy/radar.json.zip",
